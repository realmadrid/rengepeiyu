...
<title>人格培育系统激活页面</title>
<link rel="stylesheet" type="text/css" media="screen" href="<%=request.getContextPath() %>/css/register.css"/>
</head>
<body onload="loadteacher()">
	<div id="container">
		<div id="bg">
			<s:form action="student_reg" method="post" theme="simple">
			...
			<table id="pos">
				...
				<tr>
				 ...
				 <tr>
					<td class="w1">输入新密码：</td>
					<td class="w2"><input type="password" id="pwd" name="student.spwd"/></td>
				</tr>
				 <tr>
					<td class="w1">确认新密码：</td>
					<td class="w2"><input type="password" id="confimpwd"/></td>
				</tr>
				 <tr>
					<td class="w1">政治面貌：</td>
					<td class="w2"><input type="text" name="student.pstatus" value="<s:property value="student.pstatus"/>"/></td>
				  </tr>
				  <tr>
					<td class="w1">出生日期：</td>
      		...
      		<option>--请选择班级--</option>
				 ...
				 <tr>
					...
					<td class="w2">
					是 <input type="radio" name="student.isleader" value="true" />
					否 <input type="radio" name="student.isleader" value="false" />
					</td>
				  </tr>
