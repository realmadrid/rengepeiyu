...
<body onload="initAnswers()">
	<div id="container">
		...
		<div id="content">
		<div id="text">
		<s:form action="answer_modify" method="post"> <!-- select_answer -->
	<input type="hidden" name="qb.sid" value="${sessionScope.user.sid}"/>
	 <input type="hidden" id="answers" value="<s:property value="qb.splitAnswers"/>"/>
	 <input type="hidden" name="grade" value="${sessionScope.user.grade}"/>
		<table>
				  <tr>
					<td>1.看待问题的态度</td>
				  </tr>
				  ...
				  <s:if test="#request.qb.modify">
				   <tr>
				  <td><input type="submit" value=" " onclick="return check24();" id="submit"/></td>
				  </tr>
				  </s:if>
				</table>
				</s:form>
