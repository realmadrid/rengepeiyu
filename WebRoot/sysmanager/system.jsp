...
<input type="hidden" id="context"
	...
	<div id="mainbody">
		<div id="side_bar">
			...
			<li><button type="button" name="history" class="b" id="history">历史查询</button></li>
			<li><button type="button" name="personal" class="b" id="personal">单个同学</button></li>
			...
			<li class="tab1">
				...
				<li><div id="a1"><a href="allcpl">参评率</a></div></li>
				<li><div id="a1"><a href="all11">11项基本能力</a></div></li>
				<li><div id="a1"><a href="allsuyang">素养层级</a></div></li>
				<li><div id="a1"><a href="all24">24道题</a></div></li>
